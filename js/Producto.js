				  ...
				  if (result.value) {
				  	$.post('../controlador/ProductoController.php',{id,funcion},(response)=>{
				  		...
				  		if (response=='borrado') {
				  			 ...
				  			 swalWithBootstrapButtons.fire(
							      'Borrado!',
							      'El producto '+ nombre+'no fue borrado por que esta siendo usado por un lote.',
							      'error'
				    			)
				  		}
				  	})
