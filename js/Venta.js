$(document).ready(function() {
	...
	let  datatable =$('#tabla_venta').DataTable( {
        ...
        "columns": [
            ...
            { "data": "total" },
            { "data": "vendedor" }, 
            { "defaultContent": ` <!--<button class="btn btn-secondary"><i class="fas fa-print"></i>eliminar</button> -->
                                 <button class="ver btn btn-sm btn-primary" type="button" data-toggle="modal" data-target="#vista_venta">Reporte</button>
                           <!--      <button class="btn btn-danger"><i class="fas fa-window-close"></i>modificar</button>  -->
                                 `}
        ],
        "language":espanol
    } );
